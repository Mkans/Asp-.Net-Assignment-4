...
{
    public class MKProvinceController : Controller
    {
        private readonly BusServiceContext _context;

        public MKProvinceController(BusServiceContext context)
        {
            _context = context;    
        }
